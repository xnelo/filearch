...
public class Hmac1 extends AbstractRoutine<byte[]> {
     ...
     */
    public Hmac1() {
        super("hmac", Filearch.FILEARCH, DSL.comment(""), SQLDataType.BLOB);
