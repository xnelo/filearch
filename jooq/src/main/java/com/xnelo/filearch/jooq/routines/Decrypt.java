...
public class Decrypt extends AbstractRoutine<byte[]> {
     ...
     */
    public Decrypt() {
        super("decrypt", Filearch.FILEARCH, DSL.comment(""), SQLDataType.BLOB);
