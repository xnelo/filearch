...
public class PgpSymEncryptBytea2 extends AbstractRoutine<byte[]> {
  ...
  public PgpSymEncryptBytea2() {
    super("pgp_sym_encrypt_bytea", Filearch.FILEARCH, DSL.comment(""), SQLDataType.BLOB);
