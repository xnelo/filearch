...
public class PgpPubDecrypt3 extends AbstractRoutine<String> {
    ...
    public PgpPubDecrypt3() {
        super("pgp_pub_decrypt", Filearch.FILEARCH, DSL.comment(""), SQLDataType.CLOB);
