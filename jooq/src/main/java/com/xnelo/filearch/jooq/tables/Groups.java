...
public class Groups extends TableImpl<GroupsRecord> {
    ...
    /**
     * The reference instance of <code>FILEARCH.groups</code>
     */
    ...
    /**
     * The column <code>FILEARCH.groups.id</code>.
     */
    ...
    /**
     * The column <code>FILEARCH.groups.owner_user_id</code>.
     */
    public final TableField<GroupsRecord, Long> OWNER_USER_ID = createField(DSL.name("owner_user_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>FILEARCH.groups.group_name</code>.
     */
    public final TableField<GroupsRecord, byte[]> GROUP_NAME = createField(DSL.name("group_name"), SQLDataType.BLOB, this, "");
    ...
    /**
     * Create an aliased <code>FILEARCH.groups</code> table reference
     */
    ...
    /**
     * Create a <code>FILEARCH.groups</code> table reference
     */
    public Groups() {
