...
public class Armor2 extends AbstractRoutine<String> {
     ...
     */
    public Armor2() {
        super("armor", Filearch.FILEARCH, DSL.comment(""), SQLDataType.CLOB);
