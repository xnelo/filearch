...
public class Folders extends TableImpl<FoldersRecord> {
    ...
    /**
     * The reference instance of <code>FILEARCH.folders</code>
     */
    ...
    /**
     * The column <code>FILEARCH.folders.id</code>.
     */
    public final TableField<FoldersRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>FILEARCH.folders.owner_user_id</code>.
     */
    public final TableField<FoldersRecord, Long> OWNER_USER_ID = createField(DSL.name("owner_user_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>FILEARCH.folders.parent_id</code>.
     */
    public final TableField<FoldersRecord, Long> PARENT_ID = createField(DSL.name("parent_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>FILEARCH.folders.name</code>.
     */
    public final TableField<FoldersRecord, byte[]> NAME = createField(DSL.name("name"), SQLDataType.BLOB, this, "");
    ...
    /**
     * Create an aliased <code>FILEARCH.folders</code> table reference
     */
    ...
    /**
     * Create a <code>FILEARCH.folders</code> table reference
     */
    public Folders() {
    ...
    @Override
    public Identity<FoldersRecord, Long> getIdentity() {
        return (Identity<FoldersRecord, Long>) super.getIdentity();
    }
