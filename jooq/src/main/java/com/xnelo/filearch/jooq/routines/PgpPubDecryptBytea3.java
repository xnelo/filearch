...
public class PgpPubDecryptBytea3 extends AbstractRoutine<byte[]> {
    ...
    public PgpPubDecryptBytea3() {
        super("pgp_pub_decrypt_bytea", Filearch.FILEARCH, DSL.comment(""), SQLDataType.BLOB);
