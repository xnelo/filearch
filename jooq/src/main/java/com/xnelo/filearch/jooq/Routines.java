...
public class Routines {
  ...
  public static String pgpSymDecryptNullOnErr(
      Configuration configuration, byte[] data, String psw) {
  ...
  public static Field<String> pgpSymDecryptNullOnErr(byte[] data, String psw) {
    PgpSymDecryptNullOnErr f = new PgpSymDecryptNullOnErr();
    f.setData(data);
    f.setPsw(psw);
  ...
  /** Get <code>FILEARCH.pgp_sym_decrypt_null_on_err</code> as a field. */
  public static Field<String> pgpSymDecryptNullOnErr(Field<byte[]> data, Field<String> psw) {
    PgpSymDecryptNullOnErr f = new PgpSymDecryptNullOnErr();
    f.setData(data);
    f.setPsw(psw);
