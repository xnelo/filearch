...
import com.xnelo.filearch.jooq.Indexes;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
  ...
  /** The reference instance of <code>FILEARCH.flyway_schema_history</code> */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.installed_rank</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.version</code>. */
  public final TableField<FlywaySchemaHistoryRecord, String> VERSION =
      createField(DSL.name("version"), SQLDataType.VARCHAR(50), this, "");

  /** The column <code>FILEARCH.flyway_schema_history.description</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.type</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.script</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.checksum</code>. */
  public final TableField<FlywaySchemaHistoryRecord, Integer> CHECKSUM =
      createField(DSL.name("checksum"), SQLDataType.INTEGER, this, "");

  /** The column <code>FILEARCH.flyway_schema_history.installed_by</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.installed_on</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.execution_time</code>. */
  ...
  /** The column <code>FILEARCH.flyway_schema_history.success</code>. */
  ...
  /** Create an aliased <code>FILEARCH.flyway_schema_history</code> table reference */
  ...
  /** Create a <code>FILEARCH.flyway_schema_history</code> table reference */
