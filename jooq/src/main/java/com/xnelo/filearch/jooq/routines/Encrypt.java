...
public class Encrypt extends AbstractRoutine<byte[]> {
     ...
     */
    public Encrypt() {
        super("encrypt", Filearch.FILEARCH, DSL.comment(""), SQLDataType.BLOB);
