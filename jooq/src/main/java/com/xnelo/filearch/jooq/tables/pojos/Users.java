...
public class Users implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        else if (!Arrays.equals(this.username, other.username))
            return false;
        if (this.firstName == null) {
            if (other.firstName != null)
                return false;
        }
        else if (!Arrays.equals(this.firstName, other.firstName))
            return false;
        if (this.lastName == null) {
            if (other.lastName != null)
                return false;
        }
        else if (!Arrays.equals(this.lastName, other.lastName))
            return false;
        if (this.email == null) {
            if (other.email != null)
                return false;
        }
        else if (!Arrays.equals(this.email, other.email))
            return false;
