...
public class StoredFiles extends TableImpl<StoredFilesRecord> {
  ...
  public final TableField<StoredFilesRecord, String> STORAGE_TYPE =
      createField(DSL.name("storage_type"), SQLDataType.VARCHAR(3), this, "");

  /** The column <code>FILEARCH.stored_files.storage_key</code>. */
  public final TableField<StoredFilesRecord, String> STORAGE_KEY =
      createField(DSL.name("storage_key"), SQLDataType.VARCHAR, this, "");
  ...
  private StoredFiles(
      Name alias, Table<StoredFilesRecord> aliased, Field<?>[] parameters, Condition where) {
