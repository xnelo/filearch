...
public class PgpArmorHeaders extends TableImpl<PgpArmorHeadersRecord> {
  ...
  /** The reference instance of <code>FILEARCH.pgp_armor_headers</code> */
  ...
  /** The column <code>FILEARCH.pgp_armor_headers.key</code>. */
  public final TableField<PgpArmorHeadersRecord, String> KEY =
      createField(DSL.name("key"), SQLDataType.CLOB, this, "");

  /** The column <code>FILEARCH.pgp_armor_headers.value</code>. */
  ...
  /** Create an aliased <code>FILEARCH.pgp_armor_headers</code> table reference */
  ...
  /** Create a <code>FILEARCH.pgp_armor_headers</code> table reference */
