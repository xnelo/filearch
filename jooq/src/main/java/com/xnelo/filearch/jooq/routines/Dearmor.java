...
public class Dearmor extends AbstractRoutine<byte[]> {
     ...
     */
    public Dearmor() {
        super("dearmor", Filearch.FILEARCH, DSL.comment(""), SQLDataType.BLOB);
